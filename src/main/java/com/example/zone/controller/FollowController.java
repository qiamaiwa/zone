...
@Controller
public class FollowController  implements ZoneConstant {
    ...
    public String follow(int entityType, int entityId) {
        ...
        event.setTopic(TOPIC_FOLLOW).setUserId(hostHolder.getUser().getId()).setEntityType(entityType).setEntityId(entityId).setEntityUserId(entityId);
        ...
        return ZoneUtil.getJSONString(0, "已关注!");
    }
    ...
    public String unfollow(int entityType, int entityId) {
        ...
        return ZoneUtil.getJSONString(0, "已取消关注!");
    }

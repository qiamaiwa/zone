...
import com.example.zone.entity.Message;
import com.example.zone.entity.Page;
import com.example.zone.entity.User;
import com.example.zone.service.MessageService;
...
@Controller
public class MessageController implements ZoneConstant {
    ...
    public String getLetterDetail(@PathVariable("conversationId") String conversationId, Page page, Model model) {
        ...
        //系统通知
        model.addAttribute("noticeUnreadCount", messageService.findNoticeUnreadCount(hostHolder.getUser().getId(), null));
        // 设置已读
    ...
    public String sendLetter(String toName, String content) {
        ...
        if (target == null) {
            return ZoneUtil.getJSONString(1, "目标用户不存在!");
        }

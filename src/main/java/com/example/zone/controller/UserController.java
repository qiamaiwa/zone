...
import com.example.zone.service.FollowService;
...
@Controller
@RequestMapping("/user")
public class UserController  implements ZoneConstant {

    private static final Logger logger = LoggerFactory.getLogger(UserController.class);

    @Value("${zone.path.upload}")
    ...
    public String uploadHeader(MultipartFile headerImage, Model model) {
        ...
        // 生成随机文件名
        fileName = ZoneUtil.generateUUID() + suffix;
        // 确定文件存放的路径
